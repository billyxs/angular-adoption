 ...
 * Time: 6:32 PM
 *
 * Edited to support angular-momentum-scroll
 */
'use strict';

angular.module('selectbox', ['angular-momentum-scroll'])
    ...
    .controller('SelectBoxCtrl', ['$scope', '$document', '$element', '$timeout', 'SelectBox', function($scope, $document, $element, $timeout, SelectBox) {
        SelectBox.init();

        // iScroll scrolling params
        ...
        $scope.scrollReport = function(x, y) {
          $scope.scrollY = y;
        }
        ...
        var clickHandler = function(e) {
            ...
            // console.log('click hanlder', targetId);
        ...
        var mouseDownHandler = function(e) {
          // e.stopPropagation();
              ...
              // trigger the scrollable offsetHeight
              $scope.$apply();
          var $element = angular.element(e.target);
          var targetId = $element.attr('id');
        ...
        var mouseUpHandler = function(e) {
          ...
          // console.log('check', ! mouseDownElement.hasClass('.mad-selectbox-item'), (mouseDownElement.attr('id') === $element.attr('id')));
          // console.log('attr', mouseDownElement.attr('class'), $element.attr('id'), mouseDownElement.attr('id') );
          if (! mouseDownElement.hasClass('mad-selectbox-item') && mouseDownElement.attr('id') == $element.attr('id') ) {
            $scope.view.show = false;
            $scope.$apply();
            unbindEvents();
          }
        ...
        $scope.toggleList = function() {
            ...
            if ($scope.view.show) {
              // seems to help the scroller directive to propagate properly
              $timeout(function() {}, 200, true);
    ...
    .directive('selectbox', [function() {
        return {
            ...
            template: '<div tabindex="{{ view.tabindex }}" class="mad-selectbox" ng-class="{\'mad-selectbox-multi\': multi}">'+
                        ...
                        '</a>'+
                        '<ul class="mad-selectbox-dropdown {{view.instanceId}}" ng-show="view.show" scrollable curr-y="scrollY" parameters="{{ iScrollParameters }}" on-scroll-end="scrollReport(X, Y)">'+
